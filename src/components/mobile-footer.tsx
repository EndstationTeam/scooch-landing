...
export type MobileFooterType = {
  className?: string;
};


const MobileFooter: FunctionComponent<MobileFooterType> = ({ className = "" }) => {
  return (
    <footer
      className={`
      self-stretch 
    ...
    >
      ...
      className="
        flex-1
        /* Base: column, center items */
        flex flex-col items-center justify-center

        /* md+: row, top-align, space-between horizontally */
        flex-row md:items-start md:justify-between
      ...
      {/*
        LEFT COLUMN
        For small screens -> items-center
        For md+ -> items-start (left aligned)
      */}
      <div 
        className="
        w-[452px]
      ...
      >
        ...
        <div className="self-stretch flex flex-col items-center md:items-start lg:items-start xl:items-start justify-center md:justify-start lg:justify-start xl:justify-start gap-4">
          ...
          <div className="flex flex-row items-center gap-6 text-white text-sm mt-2">
      ...
      {/*
        RIGHT COLUMN
        For small screens -> stacked below left column, centered 
        For md+ -> aligned to the right
      */}
      <div 
        className="
        flex flex-col
