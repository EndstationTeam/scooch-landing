...
const FrameComponent: FunctionComponent<FrameComponentType> = ({
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 pb-[172px] pl-px pr-0 box-border max-w-full text-left text-53xl text-white font-h2 mq900:pb-[47px] mq900:box-border mq1300:pb-[73px] mq1300:box-border ${className}`}
    >
      <div className="flex-1 [background:radial-gradient(50%_50%_at_50%_50%,_rgba(71,_45,_0,_0.82),_rgba(25,_28,_28,_0))] flex flex-col items-start justify-start gap-[75px] max-w-full mq900:gap-[37px] mq450:gap-[19px]">
        ...
        <header className="self-stretch h-[120px] flex flex-row items-start justify-start py-[31px] px-40 box-border gap-[1042px] top-[0] z-[99] sticky mq900:gap-[260px] mq900:pl-10 mq900:pr-10 mq900:box-border mq450:gap-[130px] mq1300:gap-[521px] mq1300:pl-20 mq1300:pr-20 mq1300:box-border">
          ...
          <div className="flex flex-col items-start justify-start gap-[175px] max-w-full mq900:gap-11 mq450:gap-[22px] mq1300:gap-[87px]">
            <div className="self-stretch flex flex-row items-start justify-start py-0 px-px box-border max-w-full">
              <div className="h-[650px] flex-1 relative max-w-full">
                <h1 className="m-0 absolute top-[224px] left-[0px] text-inherit font-black font-[inherit] inline-block w-[559px] h-[86px] z-[1] mq900:text-39xl mq450:text-24xl">
                  Park Anywhere
                </h1>
                <h2 className="m-0 absolute top-[300px] left-[0px] text-11xl font-medium font-[inherit] text-orange inline-block w-[644px] h-9 z-[1] mq900:text-5xl mq450:text-lg">
                  With the only parking app you’ll ever need
                </h2>
                <Button
                  className="absolute top-[368px] left-[0px]"
                  disableElevation
                  variant="contained"
                  sx={{
                    color: "#151818",
                ...
                <img
                  className="absolute top-[383px] left-[277px] w-[109px] h-7 overflow-hidden z-[1]"
                  loading="lazy"
                  alt=""
                  src="/app-store.svg"
                />
                <img
                  className="absolute top-[383px] left-[416px] w-[118px] h-7 overflow-hidden z-[1]"
                  loading="lazy"
                  alt=""
                  src="/google-play.svg"
                />
                <div className="absolute h-full top-[0px] bottom-[0px] left-[577px] w-[830px] overflow-hidden flex flex-row items-start justify-start z-[2]">
                  <div className="h-[795.1px] w-[843.2px] absolute !m-[0] right-[-13.2px] bottom-[-83.1px]">
                    ...
                    />
                    <img
                      className="absolute top-[0px] left-[311.3px] w-[531.9px] h-[688.8px] object-contain z-[1]"
                      loading="lazy"
                      alt=""
            ...
            <div className="self-stretch flex flex-col items-end justify-start gap-10 max-w-full text-center text-21xl mq900:gap-5">
              <div className="self-stretch flex flex-row items-start justify-center py-0 pl-[21px] pr-5 box-border max-w-full">
                <div className="w-[772px] flex flex-col items-start justify-start gap-2.5 max-w-full">
                  ...
                  <div className="self-stretch flex flex-row items-start justify-start py-0 pl-[217px] pr-[216px] box-border max-w-full text-left text-base mq900:pl-[108px] mq900:pr-[108px] mq900:box-border mq450:pl-5 mq450:pr-5 mq450:box-border">
